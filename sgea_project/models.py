...
class Evento(models.Model):
    ...
    id_organizador_fk = models.ForeignKey(Usuario, on_delete=models.CASCADE, related_name='eventos_organizados')

class Inscricao(models.Model):
    data_inscricao = models.DateField(auto_now_add=True)
    id_usuario_fk = models.ForeignKey(Usuario, on_delete=models.CASCADE, related_name='inscricoes')
...
class Certificado(models.Model):
    ...
    id_usuario_fk = models.ForeignKey(Usuario, on_delete=models.CASCADE, related_name='certificados')
    id_evento_fk = models.ForeignKey(Evento, on_delete=models.CASCADE)
